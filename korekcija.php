        ...
        <div class="row text-center justify-content-center">
            <div class="col-12 mb-5">
                <h2 class="text-center section__header">
                    <span><?php the_field('title_korekcija');?></span><br><strong><?php the_field('title2_korekcija'); ?></strong>
                </h2>
            </div>
        </div>
		<?php
			if( have_rows('slider_korekcija') ):
			while ( have_rows('slider_korekcija') ) : the_row();
		?>
		<div class="twentytwenty-container mb-4">
            <!-- The before image is first -->
            <img alt="Slika prije zahvata" src="<?php the_sub_field('img_korekcija'); ?>"/>
            <!-- The after image is last -->
            <img alt="Slika poslije zahvata" src="<?php the_sub_field('img2_korekcija'); ?>"/>
        </div>
		<?php 
			endwhile;
			else :
